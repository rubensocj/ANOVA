#' @Title
#' Gráfico de interação bidirecional
#' 
#' @description 
#' Cria um gráfico de interação bidirecional, comumente usado na
#' Análise de Variância (ANOVA) com dois fatores.
#'
#' @details
#' O gráfico exibe a média da variável dependente (resposta) para
#' as combinações bidirecionais dos fatores e adiciona barras de erro
#' com o intervalo de confiança de 95% para a média.
#'
#' @param data data.frame com o conjunto de dados estudado.
#' @param x string com o nome da coluna para o fator 1.
#' @param y string com o nome da coluna da variável dependente (resposta).
